...
class btBulletXmlWorldImporter : public btWorldImporter {
 protected:
  ...
  btAlignedObjectArray<btAlignedObjectArray<btCompoundShapeChildData>*>
      m_compoundShapeChildDataArrays;
  ...
  void deSerializeVector3FloatData(
      tinyxml2::XMLNode* pParent,
      btAlignedObjectArray<btVector3FloatData>& vectors);
  ...
  void deSerializeCollisionShapeData(tinyxml2::XMLNode* pParent,
