...
// Store x, y, and z elements of a 3-D vector in the first three words of a
// float array.
// Memory area of previous 16 bytes and next 32 bytes from fptr might be
// accessed
//
...
// Store a 3-D vector as half-floats. Memory area of previous 16 bytes and next
// 32 bytes from <code><i>hfptr</i></code> might be accessed.
// NOTE:
// This transformation does not support either denormalized numbers or NaNs.
// Memory area of previous 16 bytes and next 32 bytes from hfptr might be
// accessed.
//
...
// Store x, y, z, and w elements of a 4-D vector in the first four words of a
// float array.
// Memory area of previous 16 bytes and next 32 bytes from fptr might be
// accessed
//
...
// Store a 4-D vector as half-floats. Memory area of previous 16 bytes and next
// 32 bytes from <code><i>hfptr</i></code> might be accessed.
// NOTE:
// This transformation does not support either denormalized numbers or NaNs.
// Memory area of previous 16 bytes and next 32 bytes from hfptr might be
...
// Store x, y, and z elements of a 3-D point in the first three words of a float
// array.
// Memory area of previous 16 bytes and next 32 bytes from fptr might be
// accessed
//
...
// Store a 3-D point as half-floats. Memory area of previous 16 bytes and next
// 32 bytes from <code><i>hfptr</i></code> might be accessed.
// NOTE:
// This transformation does not support either denormalized numbers or NaNs.
// Memory area of previous 16 bytes and next 32 bytes from hfptr might be
...
class Quat {
 ...
 public:
  ...
  // directions.
  //
  static inline const Quat rotation(const Vector3 &unitVec0,
                                    const Vector3 &unitVec1);
...
//
inline const Quat squad(float t, const Quat &unitQuat0, const Quat &unitQuat1,
                        const Quat &unitQuat2, const Quat &unitQuat3);
...
// Store x, y, z, and w elements of a quaternion in the first four words of a
// float array.
// Memory area of previous 16 bytes and next 32 bytes from fptr might be
// accessed
//
...
class Matrix4 {
 ...
 public:
  ...
  //
  inline Matrix4(const Vector4 &col0, const Vector4 &col1, const Vector4 &col2,
                 const Vector4 &col3);
  ...
  // direction
  //
  static inline const Matrix4 lookAt(const Point3 &eyePos,
                                     const Point3 &lookAtPos,
                                     const Vector3 &upVec);

  // Construct a perspective projection matrix
  //
  static inline const Matrix4 perspective(float fovyRadians, float aspect,
                                          float zNear, float zFar);

  // Construct a perspective projection matrix based on frustum
  //
  static inline const Matrix4 frustum(float left, float right, float bottom,
                                      float top, float zNear, float zFar);

  // Construct an orthographic projection matrix
  //
  static inline const Matrix4 orthographic(float left, float right,
...
class Transform3 {
 ...
 public:
  ...
  //
  inline Transform3(const Vector3 &col0, const Vector3 &col1,
  ...
  // vector
  //
  static inline const Transform3 rotation(float radians,
