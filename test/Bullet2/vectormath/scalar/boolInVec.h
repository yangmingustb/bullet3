...
//
inline const boolInVec select(boolInVec vec0, boolInVec vec1,
...
inline boolInVec::boolInVec(bool scalar) { mData = -(int)scalar; }

inline bool boolInVec::getAsBool() const { return (mData > 0); }

#ifndef _VECTORMATH_NO_SCALAR_CAST
inline boolInVec::operator bool() const { return getAsBool(); }
#endif
...
inline boolInVec& boolInVec::operator=(boolInVec vec) {
  mData = vec.mData;
  return *this;
}
