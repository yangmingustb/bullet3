...
static void v3skew_ref(const btVector3* v, btVector3* v1, btVector3* v2,
                       btVector3* v3);
    ...
    */
    if (!(v1 == vt1)) {
      vlog(
          ...
          v1.m_floats[0], v1.m_floats[1], v1.m_floats[2], vt1.m_floats[0],
          vt1.m_floats[1], vt1.m_floats[2]);
    ...
    */
    if (!(v2 == vt2)) {
      vlog(
          ...
          v2.m_floats[0], v2.m_floats[1], v2.m_floats[2], vt2.m_floats[0],
          vt2.m_floats[1], vt2.m_floats[2]);
    ...
    */
    if (!(v3 == vt3)) {
      vlog(
          ...
          v3.m_floats[0], v3.m_floats[1], v3.m_floats[2], vt3.m_floats[0],
          vt3.m_floats[1], vt3.m_floats[2]);
...
#define DATA_SIZE 256
...

  {
    ...
    for (j = 0; j < NUM_CYCLES; j++) {
      ...
      for (k = 0; k < LOOPCOUNT; k++) {
        size_t k32 = (k & (DATA_SIZE - 1));
        v3_arr0[k32].getSkewSymmetricMatrix(&v3_arr1[k32], &v3_arr2[k32],
                                            &v3_arr3[k32]);
      }
      currentTime = ReadTicks() - startTime;
