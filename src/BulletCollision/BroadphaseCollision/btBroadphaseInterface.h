...
/// The btBroadphaseInterface class provides an interface to detect
/// aabb-overlapping object pairs.
/// Some implementations for this broadphase interface include btAxisSweep3,
/// bt32BitAxisSweep3 and btDbvtBroadphase.
/// The actual overlapping pair management, storage, adding and removing of
/// pairs is dealt by the btOverlappingPairCache class.
class btBroadphaseInterface {
 public:
  ...
  /// calculateOverlappingPairs is optional: incremental algorithms (sweep and
  /// prune) might do it during the set aabb
  ...
  virtual void getBroadphaseAabb(btVector3& aabbMin,
                                 btVector3& aabbMax) const = 0;
