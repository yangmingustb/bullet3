...
// 宽相节点
/// The btBroadphaseProxy is the main class that can be used with the Bullet
/// broadphases.
/// It stores collision shape type information, collision filter
// information and a client object, typically a btCollisionObject or
// btRigidBody.
...
btBroadphaseProxy {
  ...
  SIMD_FORCE_INLINE int getUid() const { return m_uniqueId; }

  // used for memory pools
  btBroadphaseProxy() : m_clientObject(0) {}

  btBroadphaseProxy(const btVector3& aabbMin, const btVector3& aabbMax,
  ...
  static SIMD_FORCE_INLINE bool isConvex2d(int proxyType) {
    return (proxyType == BOX_2D_SHAPE_PROXYTYPE) ||
           (proxyType == CONVEX_2D_SHAPE_PROXYTYPE);
  }
};
...
/// A btDispatcher can search a btCollisionAlgorithm that performs
//  exact/narrowphase collision detection on the actual collision shapes.
ATTRIBUTE_ALIGNED16(struct)
btBroadphasePair {
  btBroadphasePair()
      : m_pProxy0(0), m_pProxy1(0), m_algorithm(0), m_internalInfo1(0) {}
...
SIMD_FORCE_INLINE bool operator<(const btBroadphasePair& a, const
btBroadphasePair& b)
{
...
class btBroadphasePairSortPredicate {
 public:
  bool operator()(const btBroadphasePair& a, const btBroadphasePair& b) const {
    ...
    return uidA0 > uidB0 || (a.m_pProxy0 == b.m_pProxy0 && uidA1 > uidB1) ||
           (a.m_pProxy0 == b.m_pProxy0 && a.m_pProxy1 == b.m_pProxy1 &&
