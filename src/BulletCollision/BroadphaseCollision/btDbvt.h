...
struct btDbvt
{
	...
	// stack, using memory allocations, and it recomputes signs/rayDirectionInverses each time
	DBVT_PREFIX
	...
	// (to reduce dynamic memory allocations to a minimum) and it uses precomputed signs/rayInverseDirections
