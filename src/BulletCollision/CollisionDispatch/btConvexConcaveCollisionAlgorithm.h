...
/// convex (m_convexProxy), processTriangle is called.
...
/// btConvexConcaveCollisionAlgorithm  supports collision between convex shapes
 ...
 public:
  ...
  struct CreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      return new (mem)
          btConvexConcaveCollisionAlgorithm(ci, body0Wrap, body1Wrap, false);
    }
  };
  ...
  struct SwappedCreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btConvexConcaveCollisionAlgorithm));
      return new (mem)
          btConvexConcaveCollisionAlgorithm(ci, body0Wrap, body1Wrap, true);
    }
  };
};
