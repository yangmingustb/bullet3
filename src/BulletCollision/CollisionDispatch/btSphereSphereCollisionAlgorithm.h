...
/// btSphereSphereCollisionAlgorithm  provides sphere-sphere collision
/// detection.
  ...
  struct CreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btSphereSphereCollisionAlgorithm));
      return new (mem)
          btSphereSphereCollisionAlgorithm(0, ci, col0Wrap, col1Wrap);
    }
  };
};
