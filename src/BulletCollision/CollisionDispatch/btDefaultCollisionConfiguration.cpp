...
// btDefaultCollisionConfiguration::btDefaultCollisionConfiguration(btStackAlloc*
// stackAlloc,btPoolAllocator*	persistentManifoldPool,btPoolAllocator*
// collisionAlgorithmPool)
{
  void* mem = NULL;
  ...
  m_convexConvexCreateFunc =
      new (mem) btConvexConvexAlgorithm::CreateFunc(m_pdSolver);
  mem =
      btAlignedAlloc(sizeof(btConvexConcaveCollisionAlgorithm::CreateFunc), 16);
  m_convexConcaveCreateFunc =
      new (mem) btConvexConcaveCollisionAlgorithm::CreateFunc;
  mem =
      btAlignedAlloc(sizeof(btConvexConcaveCollisionAlgorithm::CreateFunc), 16);
  m_swappedConvexConcaveCreateFunc =
      new (mem) btConvexConcaveCollisionAlgorithm::SwappedCreateFunc;
  mem = btAlignedAlloc(sizeof(btCompoundCollisionAlgorithm::CreateFunc), 16);
  m_compoundCreateFunc = new (mem) btCompoundCollisionAlgorithm::CreateFunc;

  mem = btAlignedAlloc(sizeof(btCompoundCompoundCollisionAlgorithm::CreateFunc),
                       16);
  m_compoundCompoundCreateFunc =
      new (mem) btCompoundCompoundCollisionAlgorithm::CreateFunc;

  mem = btAlignedAlloc(sizeof(btCompoundCollisionAlgorithm::SwappedCreateFunc),
                       16);
  m_swappedCompoundCreateFunc =
      new (mem) btCompoundCollisionAlgorithm::SwappedCreateFunc;
  mem = btAlignedAlloc(sizeof(btEmptyAlgorithm::CreateFunc), 16);
  m_emptyCreateFunc = new (mem) btEmptyAlgorithm::CreateFunc;

  mem =
      btAlignedAlloc(sizeof(btSphereSphereCollisionAlgorithm::CreateFunc), 16);
  ...
  mem = btAlignedAlloc(sizeof(btSphereTriangleCollisionAlgorithm::CreateFunc),
                       16);
  ...
  /// calculate maximum element size, big enough to fit any collision algorithm
  /// in the memory pool
  ...
  int collisionAlgorithmMaxElementSize =
      btMax(maxSize, constructionInfo.m_customCollisionAlgorithmMaxElementSize);
  ...
  if (constructionInfo.m_persistentManifoldPool) {
    ...
    m_persistentManifoldPool = new (mem) btPoolAllocator(
        sizeof(btPersistentManifold),
        constructionInfo.m_defaultMaxPersistentManifoldPoolSize);
  }

  collisionAlgorithmMaxElementSize =
      (collisionAlgorithmMaxElementSize + 16) & 0xffffffffffff0;
  if (constructionInfo.m_collisionAlgorithmPool) {
    ...
    void* mem = btAlignedAlloc(sizeof(btPoolAllocator), 16);
    m_collisionAlgorithmPool = new (mem) btPoolAllocator(
        collisionAlgorithmMaxElementSize,
...
btDefaultCollisionConfiguration::getClosestPointsAlgorithmCreateFunc(
  ...
  if (btBroadphaseProxy::isConvex(proxyType0) &&
      btBroadphaseProxy::isConvex(proxyType1)) {
...
void btDefaultCollisionConfiguration::setConvexConvexMultipointIterations(
  ...
  convexConvex->m_minimumPointsPerturbationThreshold =
...
void btDefaultCollisionConfiguration::setPlaneConvexMultipointIterations(
  ...
  cpCF->m_minimumPointsPerturbationThreshold =
      minimumPointsPerturbationThreshold;
  ...
  pcCF->m_minimumPointsPerturbationThreshold =
      minimumPointsPerturbationThreshold;
}
