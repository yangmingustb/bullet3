...
/// This is useful for creating a character controller, collision
/// sensors/triggers, explosions etc.
...
btGhostObject : public btCollisionObject {
 ...
 public:
  ...
  /// this method is mainly for expert/internal use only.
  virtual void removeOverlappingObjectInternal(
...
/// The btGhostPairCallback interfaces and forwards adding and removal of
/// overlapping pairs from the btBroadphaseInterface to btGhostObject.
class btGhostPairCallback : public btOverlappingPairCallback {
 public:
  ...
  virtual btBroadphasePair* addOverlappingPair(btBroadphaseProxy* proxy0,
    ...
    if (ghost0) ghost0->addOverlappingObjectInternal(proxy1, proxy0);
    if (ghost1) ghost1->addOverlappingObjectInternal(proxy0, proxy1);
    return 0;
  }
