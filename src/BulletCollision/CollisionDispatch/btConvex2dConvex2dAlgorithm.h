...
/// The convex2dConvex2dAlgorithm collision algorithm support 2d collision
/// detection for btConvex2dShape
/// Currently it requires the btMinkowskiPenetrationDepthSolver, it has support
/// for 2d penetration depth computation
  ...
  struct CreateFunc : public btCollisionAlgorithmCreateFunc {
    ...
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btConvex2dConvex2dAlgorithm));
