...
/// These callbacks are used to customize the algorith that combine restitution,
/// friction, damping, Stiffness
typedef btScalar (*CalculateCombinedCallback)(const btCollisionObject* body0,
...
class btManifoldResult : public btDiscreteCollisionDetectorInterface::Result {
 ...
 public:
  ...
  btManifoldResult(const btCollisionObjectWrapper* body0Wrap,
  ...
  btPersistentManifold* getPersistentManifold() { return m_manifoldPtr; }
  ...
  SIMD_FORCE_INLINE void refreshContactPoints() {
    ...
    if (!m_manifoldPtr->getNumContacts()) return;
  ...
  const btCollisionObjectWrapper* getBody0Wrap() const { return m_body0Wrap; }
  const btCollisionObjectWrapper* getBody1Wrap() const { return m_body1Wrap; }
  ...
  /// in the future we can let the user override the methods to combine
  /// restitution and friction
  static btScalar calculateCombinedRestitution(const btCollisionObject* body0,
                                               const btCollisionObject* body1);
  static btScalar calculateCombinedFriction(const btCollisionObject* body0,
                                            const btCollisionObject* body1);
  static btScalar calculateCombinedRollingFriction(
      const btCollisionObject* body0, const btCollisionObject* body1);
  static btScalar calculateCombinedSpinningFriction(
      const btCollisionObject* body0, const btCollisionObject* body1);
  static btScalar calculateCombinedContactDamping(
      const btCollisionObject* body0, const btCollisionObject* body1);
  static btScalar calculateCombinedContactStiffness(
      const btCollisionObject* body0, const btCollisionObject* body1);
};
