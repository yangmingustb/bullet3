...
SIMD_FORCE_INLINE void bt_edge_plane(const btVector3 &e1, const btVector3 &e2,
                                     const btVector3 &normal,
                                     btVector4 &plane) {
  btVector3 planenormal = (e2 - e1).cross(normal);
  planenormal.normalize();
  plane.setValue(planenormal[0], planenormal[1], planenormal[2],
                 e2.dot(planenormal));
}
...
SIMD_FORCE_INLINE int bt_line_plane_collision(const btVector4 &plane,
                                              ...
                                              btVector3 &pout, btScalar &tparam,
...
SIMD_FORCE_INLINE void bt_segment_collision(
    const btVector3 &vA1, const btVector3 &vA2, const btVector3 &vB1,
    const btVector3 &vB2, btVector3 &vPointA, btVector3 &vPointB) {
