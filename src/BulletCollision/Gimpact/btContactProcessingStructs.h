...
/// The GIM_CONTACT is an internal GIMPACT structure, similar to
/// btManifoldPoint.
...
class GIM_CONTACT {
 ...
 public:
  ...
  GIM_CONTACT(const btVector3 &point, const btVector3 &normal, btScalar depth,
  ...
  SIMD_FORCE_INLINE unsigned int calc_key_contact() const {
    int _coords[] = {(int)(m_point[0] * 1000.0f + 1.0f),
