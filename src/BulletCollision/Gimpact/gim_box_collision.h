...
class GIM_AABB {
 public:
  ...
  SIMD_FORCE_INLINE void copy_with_margin(const GIM_AABB &other,
                                          btScalar margin) {
  ...
  SIMD_FORCE_INLINE void find_intersection(const GIM_AABB &other,
                                           GIM_AABB &intersection) const {
  ...
  */
  ...
  SIMD_FORCE_INLINE bool overlapping_trans_conservative(
      const GIM_AABB &box, btTransform &trans1_to_0) {
    GIM_AABB tbox = box;
  ...
  SIMD_FORCE_INLINE bool overlapping_trans_cache(
      const GIM_AABB &box, const GIM_BOX_BOX_TRANSFORM_CACHE &transcache,
      bool fulltest) {
    // Taken from OPCODE
