...
class btGenericMemoryPool {
 public:
  ...
  size_t *m_allocated_sizes;  //[m_max_element_count];//! Number of elements
                              //allocated per node
 ...
 public:
  ...
  inline size_t gem_element_size() { return m_element_size; }

  inline size_t get_max_element_count() { return m_max_element_count; }

  inline size_t get_allocated_count() { return m_allocated_count; }

  inline size_t get_free_positions_count() { return m_free_nodes_count; }
