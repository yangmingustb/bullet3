...
class btGImpactCollisionAlgorithm : public btActivatingCollisionAlgorithm {
 protected:
  ...
  SIMD_FORCE_INLINE void checkManifold(
  ...
  // Call before process collision
  SIMD_FORCE_INLINE btCollisionAlgorithm* newAlgorithm(
      const btCollisionObjectWrapper* body0Wrap,
      const btCollisionObjectWrapper* body1Wrap) {
  ...
  // Call before process collision
  SIMD_FORCE_INLINE void checkConvexAlgorithm(
      const btCollisionObjectWrapper* body0Wrap,
      const btCollisionObjectWrapper* body1Wrap) {
  ...
  void shape_vs_shape_collision(const btCollisionObjectWrapper* body0,
  ...
  void gimpact_vs_gimpact_find_pairs(const btTransform& trans0,
 ...
 public:
  ...
  virtual void getAllContactManifolds(btManifoldArray& manifoldArray) {
    if (m_manifoldPtr) manifoldArray.push_back(m_manifoldPtr);
  }

  btManifoldResult* internalGetResultOut() { return m_resultOut; }
  ...
  struct CreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btGImpactCollisionAlgorithm));
  ...
  */
  ...
  void gimpact_vs_concave(const btCollisionObjectWrapper* body0Wrap,
                          const btCollisionObjectWrapper* body1Wrap,
                          const btGImpactShapeInterface* shape0,
                          const btConcaveShape* shape1, bool swapped);

  /// Accessor/Mutator pairs for Part and triangleID
  void setFace0(int value) { m_triface0 = value; }
  int getFace0() { return m_triface0; }
  void setFace1(int value) { m_triface1 = value; }
  int getFace1() { return m_triface1; }
  void setPart0(int value) { m_part0 = value; }
  int getPart0() { return m_part0; }
  void setPart1(int value) { m_part1 = value; }
  int getPart1() { return m_part1; }
};
