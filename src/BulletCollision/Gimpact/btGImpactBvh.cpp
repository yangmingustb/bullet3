...
void bt_begin_gim02_tree_time() { g_tree_clock.reset(); }
...
static void _find_collision_pairs_recursive(
    btGImpactBvh* boxset0, btGImpactBvh* boxset1, btPairSet* collision_pairs,
    const BT_BOX_BOX_TRANSFORM_CACHE& trans_cache_1to0, int node0, int node1,
    bool complete_primitive_tests) {
  if (_node_collision(boxset0, boxset1, trans_cache_1to0, node0, node1,
                      complete_primitive_tests) == false)
  ...
  if (boxset0->isLeafNode(node0)) {
    if (boxset1->isLeafNode(node1)) {
      ...
      _find_collision_pairs_recursive(boxset0, boxset1, collision_pairs,
                                      trans_cache_1to0, node0,
...
void btGImpactBvh::find_collision(btGImpactBvh* boxset0,
