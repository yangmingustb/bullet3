...
struct btSubSimplexClosestResult {
  ...
  void setBarycentricCoordinates(btScalar a = btScalar(0.),
...
/// btVoronoiSimplexSolver is an implementation of the closest point distance
...
#endif
{
 public:
  ...
  bool closestPtPointTetrahedron(const btVector3& p, const btVector3& a,
                                 const btVector3& b, const btVector3& c,
                                 const btVector3& d,
                                 btSubSimplexClosestResult& finalResult);
  int pointOutsideOfPlane(const btVector3& p, const btVector3& a,
                          const btVector3& b, const btVector3& c,
                          const btVector3& d);
  bool closestPtPointTriangle(const btVector3& p, const btVector3& a,
                              const btVector3& b, const btVector3& c,
 ...
 public:
  ...
  btScalar getEqualVertexThreshold() const { return m_equalVertexThreshold; }
