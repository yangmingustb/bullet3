...
/// btSimplexSolverInterface can incrementally calculate distance between origin
/// and up to 4 vertices
/// Used by GJK or Linear Casting. Can be implemented by the Johnson-algorithm
/// or alternative approaches based on
...
class btSimplexSolverInterface {
 public:
  ...
  virtual void addVertex(const btVector3& w, const btVector3& p,
                         const btVector3& q) = 0;
  ...
  virtual int getSimplex(btVector3* pBuf, btVector3* qBuf,
                         btVector3* yBuf) const = 0;
