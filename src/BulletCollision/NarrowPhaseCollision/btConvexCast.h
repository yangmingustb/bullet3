...
#endif
/// Typically the conservative advancement reaches solution in a few iterations,
/// clip it to 32 for degenerate cases.
...
class btConvexCast {
 public:
  ...
  struct CastResult {
    // virtual bool	addRayResult(const btVector3& normal,btScalar	fraction) =
    // 0;
  ...
  virtual bool calcTimeOfImpact(const btTransform& fromA,
                                ...
                                const btTransform& toB, CastResult& result) = 0;
};
