...
/// The btConeShape implements a cone shape primitive, centered around the
/// origin and aligned with the Y axis. The btConeShapeX is aligned around the X
...

{
 ...
 public:
  ...
  void setRadius(const btScalar radius) { m_radius = radius; }
  void setHeight(const btScalar height) { m_height = height; }
  ...
  int getConeUpIndex() const { return m_coneIndices[1]; }
...
class btConeShapeX : public btConeShape {
 public:
  ...
  // debugging
  virtual const char* getName() const { return "ConeX"; }
};
...
class btConeShapeZ : public btConeShape {
 public:
  ...
  // debugging
  virtual const char* getName() const { return "ConeZ"; }
};
...
/// fills the dataBuffer and returns the struct name (and 0 on failure)
SIMD_FORCE_INLINE const char* btConeShape::serialize(
