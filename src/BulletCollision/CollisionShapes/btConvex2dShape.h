...
/// The btConvex2dShape allows to use arbitrary convex shapes as 2d convex
/// shapes, with the Z component assumed to be 0.
...
btConvex2dShape : public btConvexShape {
 ...
 public:
  ...
  virtual const char* getName() const { return "Convex2dShape"; }
