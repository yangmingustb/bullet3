...
btVector3 btConvex2dShape::localGetSupportingVertexWithoutMargin(
...
btVector3 btConvex2dShape::localGetSupportingVertex(
    const btVector3& vec) const {
...
void btConvex2dShape::getAabb(const btTransform& t, btVector3& aabbMin,
                              btVector3& aabbMax) const {
  m_childConvexShape->getAabb(t, aabbMin, aabbMax);
}

void btConvex2dShape::getAabbSlow(const btTransform& t, btVector3& aabbMin,
                                  btVector3& aabbMax) const {
