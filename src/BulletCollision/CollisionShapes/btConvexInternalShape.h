...
/// The btConvexInternalShape is an internal base class, shared by most convex
/// shape implementations.
/// The btConvexInternalShape uses a default collision margin set to
/// CONVEX_DISTANCE_MARGIN.
/// This collision margin used by Gjk and some other algorithms, see also
/// btCollisionMargin.h
/// Note that when creating small shapes (derived from btConvexInternalShape),
/// you need to make sure to set a smaller collision margin, using the
/// 'setMargin' API
/// There is a automatic mechanism 'setSafeMargin' used by btBoxShape and
/// btCylinderShape
...
btConvexInternalShape : public btConvexShape {
 ...
 public:
  ...
  /// recommended,
  /// it is best to remove the body from the world, then make the change, and
  /// re-add it
  /// alternatively flush the contact points, see documentation for
  /// 'cleanProxyFromPairs'
  ...
  virtual void getAabbSlow(const btTransform& t, btVector3& aabbMin,
  ...
  btScalar getMarginNV() const { return m_collisionMargin; }
...
class btConvexInternalAabbCachingShape : public btConvexInternalShape {
 ...
 protected:
  ...
  inline void getNonvirtualAabb(const btTransform& trans, btVector3& aabbMin,
                                btVector3& aabbMax, btScalar margin) const {
