...
btBU_Simplex1to4::btBU_Simplex1to4()
    : btPolyhedralConvexAabbCachingShape(), m_numVertices(0) {
...
void btBU_Simplex1to4::getAabb(const btTransform& t, btVector3& aabbMin,
...
int btBU_Simplex1to4::getNumVertices() const { return m_numVertices; }
...
int btBU_Simplex1to4::getIndex(int) const { return 0; }
