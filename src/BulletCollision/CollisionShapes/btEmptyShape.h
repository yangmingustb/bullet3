...
/// The btEmptyShape is a collision shape without actual collision detection
/// shape, so most users should ignore this class.
/// It can be replaced by another shape during runtime, but the inertia tensor
...
btEmptyShape : public btConcaveShape {
 public:
  ...
  virtual void processAllTriangles(btTriangleCallback*, const btVector3&,
