...
void btTriangleMeshShape::getAabb(const btTransform& trans, btVector3& aabbMin,
...
class SupportVertexCallback : public btTriangleCallback {
 ...
 public:
  ...
  SupportVertexCallback(const btVector3& supportVecWorld,
...
void btTriangleMeshShape::processAllTriangles(btTriangleCallback* callback,
  ...
  struct FilteredCallback : public btInternalTriangleIndexCallback {
    ...
    FilteredCallback(btTriangleCallback* callback, const btVector3& aabbMin,
                     const btVector3& aabbMax)
        : m_callback(callback), m_aabbMin(aabbMin), m_aabbMax(aabbMax) {}
  ...
  m_meshInterface->InternalProcessAllTriangles(&filterCallback, aabbMin,
                                               aabbMax);
}
...
btVector3 btTriangleMeshShape::localGetSupportingVertex(
