...
btTriangleIndexVertexMaterialArray::btTriangleIndexVertexMaterialArray(
    ...
    unsigned char* materialBase, int materialStride, int* triangleMaterialsBase,
    int materialIndexStride)
    : btTriangleIndexVertexArray(numTriangles, triangleIndexBase,
                                 triangleIndexStride, numVertices, vertexBase,
                                 vertexStride) {
...
void btTriangleIndexVertexMaterialArray::getLockedMaterialBase(
...
void btTriangleIndexVertexMaterialArray::getLockedReadOnlyMaterialBase(
