...
/// The btConcaveShape class provides an interface for non-moving (static)
/// concave shapes.
/// It has been implemented by the btStaticPlaneShape, btBvhTriangleMeshShape
...
btConcaveShape : public btCollisionShape {
 ...
 public:
  ...
  virtual void processAllTriangles(btTriangleCallback * callback,
                                   ...
                                   const btVector3& aabbMax) const = 0;
