...
/// The btSphereShape implements an implicit sphere, centered around a local
/// origin with radius.
...

{
 public:
  ...
  virtual btScalar getMargin() const {
    // to improve gjk behaviour, use radius+margin as the full margin, so never
    // get into the penetration case
