...
/// The btConvexPointCloudShape implements an implicit convex hull of an array
/// of vertices.
...
btConvexPointCloudShape : public btPolyhedralConvexAabbCachingShape {
 ...
 public:
  ...
  SIMD_FORCE_INLINE btVector3* getUnscaledPoints() { return m_unscaledPoints; }

  SIMD_FORCE_INLINE const btVector3* getUnscaledPoints() const {
    return m_unscaledPoints;
  }

  SIMD_FORCE_INLINE int getNumPoints() const { return m_numPoints; }
