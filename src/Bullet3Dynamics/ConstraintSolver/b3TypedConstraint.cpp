...
b3TypedConstraint::b3TypedConstraint(b3TypedConstraintType type, int rbA,
                                     int rbB)
    : b3TypedObject(type),
...
b3Scalar b3TypedConstraint::getMotorFactor(b3Scalar pos, b3Scalar lowLim,
                                           b3Scalar uppLim, b3Scalar vel,
                                           b3Scalar timeFact) {
  if (lowLim > uppLim) {
...
void b3AngularLimit::set(b3Scalar low, b3Scalar high, b3Scalar _softness,
                         b3Scalar _biasFactor, b3Scalar _relaxationFactor) {
...
b3Scalar b3AngularLimit::getError() const { return m_correction * m_sign; }
