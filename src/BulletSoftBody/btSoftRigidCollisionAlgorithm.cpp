...
/// alternatively, implement special case collision algorithms (just like for
...
btSoftRigidCollisionAlgorithm::btSoftRigidCollisionAlgorithm(
    ...
    const btCollisionObjectWrapper*, const btCollisionObjectWrapper*,
    bool isSwapped)
...
void btSoftRigidCollisionAlgorithm::processCollision(
  ...
  //	const btCollisionObjectWrapper* softWrap =
  //m_isSwapped?body1Wrap:body0Wrap;
  //	const btCollisionObjectWrapper* rigidWrap =
  //m_isSwapped?body0Wrap:body1Wrap;
  btSoftBody* softBody = m_isSwapped
                             ? (btSoftBody*)body1Wrap->getCollisionObject()
                             : (btSoftBody*)body0Wrap->getCollisionObject();
  const btCollisionObjectWrapper* rigidCollisionObjectWrap =
      m_isSwapped ? body0Wrap : body1Wrap;
  ...
  if (softBody->m_collisionDisabledObjects.findLinearSearch(
    ...
    softBody->getSoftBodySolver()->processCollision(softBody,
                                                    rigidCollisionObjectWrap);
  }
}

btScalar btSoftRigidCollisionAlgorithm::calculateTimeOfImpact(
