...
struct SoftBodyConfigData {
  ...
  float m_softRigidClusterHardness;  // Soft vs rigid hardness [0,1] (cluster
                                     // only)
  float m_softKineticClusterHardness;  // Soft vs kinetic hardness [0,1]
                                       // (cluster only)
  float
      m_softSoftClusterHardness;  // Soft vs soft hardness [0,1] (cluster only)
  float m_softRigidClusterImpulseSplit;    // Soft vs rigid impulse split [0,1]
                                           // (cluster only)
  float m_softKineticClusterImpulseSplit;  // Soft vs rigid impulse split [0,1]
                                           // (cluster only)
  float m_softSoftClusterImpulseSplit;     // Soft vs rigid impulse split [0,1]
                                           // (cluster only)
