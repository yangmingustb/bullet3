...
struct btTriIndex {
  ...
  int getUid() const { return m_PartIdTriangleIndex; }
};

/// For each triangle in the concave mesh that overlaps with the AABB of a soft
...
class btSoftBodyTriangleCallback : public btTriangleCallback {
 ...
 public:
  ...
  SIMD_FORCE_INLINE const btVector3& getAabbMin() const { return m_aabbMin; }
  SIMD_FORCE_INLINE const btVector3& getAabbMax() const { return m_aabbMax; }
};

/// btSoftBodyConcaveCollisionAlgorithm  supports collision between soft body
/// shapes and (concave) trianges meshes.
  ...
  struct CreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btSoftBodyConcaveCollisionAlgorithm));
      return new (mem)
          btSoftBodyConcaveCollisionAlgorithm(ci, body0Wrap, body1Wrap, false);
    }
  };
  ...
  struct SwappedCreateFunc : public btCollisionAlgorithmCreateFunc {
    virtual btCollisionAlgorithm* CreateCollisionAlgorithm(
      ...
      void* mem = ci.m_dispatcher1->allocateCollisionAlgorithm(
          sizeof(btSoftBodyConcaveCollisionAlgorithm));
      return new (mem)
          btSoftBodyConcaveCollisionAlgorithm(ci, body0Wrap, body1Wrap, true);
    }
  };
};
