...
// btDeformableMultiBodyConstraintSolver extendsn btMultiBodyConstraintSolver to
// solve for the contact among rigid/multibody and deformable bodies. Notice
...
btDeformableMultiBodyConstraintSolver : public btMultiBodyConstraintSolver {
 ...
 protected:
  ...
  void writeToSolverBody(btCollisionObject * *bodies, int numBodies,
  ...
  virtual btScalar solveDeformableGroupIterations(
      btCollisionObject * *bodies, int numBodies,
 ...
 public:
  ...
  virtual void solveDeformableBodyGroup(
      btCollisionObject * *bodies, int numBodies,
      btCollisionObject** deformableBodies, int numDeformableBodies,
