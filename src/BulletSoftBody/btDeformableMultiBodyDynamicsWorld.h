...
class btDeformableMultiBodyDynamicsWorld : public btMultiBodyDynamicsWorld {
  ...
  typedef void (*btSolverCallback)(btScalar time,
 ...
 public:
  ...
  void setSolverCallback(btSolverCallback cb) { m_solverCallback = cb; }
  ...
  void setLineSearch(bool lineSearch) { m_lineSearch = lineSearch; }
