...
class btLemkeAlgorithm {
 public:
  btLemkeAlgorithm(const btMatrixXu& M_, const btVectorXu& q_,
...
*/
  ...
  /**
* \brief solve algorithm adapted from : Fast Implementation of Lemke’s Algorithm
* for Rigid Body Contact Simulation (John E. Lloyd)
*/
 ...
 protected:
  ...
  void GaussJordanEliminationStep(btMatrixXu& A, int pivotRowIndex,
