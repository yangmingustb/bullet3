...
btMultiBodySphericalJointMotor::btMultiBodySphericalJointMotor(
    btMultiBody* body, int link, btScalar maxMotorImpulse)
    : btMultiBodyConstraint(body, body, link, body->getLink(link).m_parent, 3,
                            true),
...
void btMultiBodySphericalJointMotor::createConstraintRows(
  ...
  btVector3 axis[3] = {btVector3(1, 0, 0), btVector3(0, 1, 0),
                       btVector3(0, 0, 1)};
  ...
  btVector3 angleDiff;
  btGeneric6DofSpring2Constraint::matrixToEulerXYZ(btMatrix3x3(relRot),
                                                   angleDiff);
      ...
      switch (m_bodyA->getLink(m_linkA).m_jointType) {
        case btMultibodyLink::eSpherical: {
          ...
          fillMultiBodyConstraint(
              constraintRow, data, 0, 0, constraintNormalAng,
              btVector3(0, 0, 0), dummy, dummy, posError, infoGlobal,
