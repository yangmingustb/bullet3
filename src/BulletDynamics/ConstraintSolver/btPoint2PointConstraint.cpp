  ...
  /// we need it for both methods
  {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      new (&m_jac[i]) btJacobianEntry(
          ...
          m_rbA.getCenterOfMassTransform() * m_pivotInA -
              m_rbA.getCenterOfMassPosition(),
          m_rbB.getCenterOfMassTransform() * m_pivotInB -
              m_rbB.getCenterOfMassPosition(),
          normal, m_rbA.getInvInertiaDiagLocal(), m_rbA.getInvMass(),
...
void btPoint2PointConstraint::getInfo2NonVirtual(
    btConstraintInfo2* info, const btTransform& body0_trans,
...
void btPoint2PointConstraint::updateRHS(btScalar timeStep) { (void)timeStep; }
