...
btScalar btTypedConstraint::getMotorFactor(btScalar pos, btScalar lowLim,
                                           btScalar uppLim, btScalar vel,
                                           btScalar timeFact) {
  if (lowLim > uppLim) {
...
void btAngularLimit::set(btScalar low, btScalar high, btScalar _softness,
...
btScalar btAngularLimit::getError() const { return m_correction * m_sign; }
