...
btSliderConstraint : public btTypedConstraint {
 ...
 public:
  ...
  btSliderConstraint(btRigidBody & rbB, const btTransform& frameInB,
                     bool useLinearReferenceFrameA);
  ...
  void getInfo2NonVirtual(btConstraintInfo2 * info, const btTransform& transA,
                          ...
                          const btVector3& linVelB, btScalar rbAinvMass,
                          btScalar rbBinvMass);
...
/// fills the dataBuffer and returns the struct name (and 0 on failure)
SIMD_FORCE_INLINE const char* btSliderConstraint::serialize(
