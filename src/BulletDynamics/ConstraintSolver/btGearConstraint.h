...
class btGearConstraint : public btTypedConstraint {
 ...
 public:
  btGearConstraint(btRigidBody& rbA, btRigidBody& rbB, const btVector3& axisInA,
  ...
  void setAxisA(btVector3& axisA) { m_axisInA = axisA; }
  void setAxisB(btVector3& axisB) { m_axisInB = axisB; }
  void setRatio(btScalar ratio) { m_ratio = ratio; }
  const btVector3& getAxisA() const { return m_axisInA; }
  const btVector3& getAxisB() const { return m_axisInB; }
  btScalar getRatio() const { return m_ratio; }
...
/// fills the dataBuffer and returns the struct name (and 0 on failure)
SIMD_FORCE_INLINE const char* btGearConstraint::serialize(
