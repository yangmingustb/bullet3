...
/// has 2 rotatioonal degrees of freedom, similar to Euler rotations around Z
/// (axis 1)
/// and Y (axis 2)
/// Description from ODE manual :
/// "Given axis 1 on body 1, and axis 2 on body 2 that is perpendicular to axis
/// 1, it keeps them perpendicular.
/// In other words, rotation of the two bodies about the direction perpendicular
...
btUniversalConstraint : public btGeneric6DofConstraint {
 ...
 public:
  ...
  btUniversalConstraint(btRigidBody & rbA, btRigidBody & rbB,
                        const btVector3& anchor, const btVector3& axis1,
