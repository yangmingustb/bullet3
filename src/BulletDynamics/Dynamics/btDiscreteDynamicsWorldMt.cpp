...
btScalar btConstraintSolverPoolMt::solveGroup(
    btCollisionObject** bodies, int numBodies, btPersistentManifold** manifolds,
  ...
  ts->solver->solveGroup(bodies, numBodies, manifolds, numManifolds,
...
btDiscreteDynamicsWorldMt::btDiscreteDynamicsWorldMt(
    ...
    : btDiscreteDynamicsWorld(dispatcher, pairCache, solverPool,
...
void btDiscreteDynamicsWorldMt::solveConstraints(
  ...
  btSimulationIslandManagerMt* im =
  ...
  im->buildAndProcessIslands(getCollisionWorld()->getDispatcher(),
                             getCollisionWorld(), m_constraints, solverParams);
...
int btDiscreteDynamicsWorldMt::stepSimulation(btScalar timeStep,
  ...
  int numSubSteps = btDiscreteDynamicsWorld::stepSimulation(
