...
static void *b3AllocDefault(size_t size) { return malloc(size); }

static void b3FreeDefault(void *ptr) { free(ptr); }
...
static void b3AlignedFreeDefault(void *ptr) { _aligned_free(ptr); }
...
static inline void b3AlignedFreeDefault(void *ptr) { free(ptr); }
#else
