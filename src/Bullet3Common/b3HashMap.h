...
struct b3HashString {
  ...
  B3_FORCE_INLINE unsigned int getHash() const { return m_hash; }

  b3HashString(const char* name) : m_string(name) {
...
class b3HashPtr {
 ...
 public:
  b3HashPtr(const void* ptr) : m_pointer(ptr) {}
...
/// A basic sample of how to use b3HashMap is located in
