...
#endif
{
 ...
 public:
  ...
  // Set Vector
  B3_FORCE_INLINE b3QuadWord(const b3SimdFloat4 vec) { mVec128 = vec; }

  // Copy constructor
  B3_FORCE_INLINE b3QuadWord(const b3QuadWord& rhs) { mVec128 = rhs.mVec128; }

  // Assignment Operator
  B3_FORCE_INLINE b3QuadWord& operator=(const b3QuadWord& v) {
    mVec128 = v.mVec128;
...
* @param z Value of z
*/
  B3_FORCE_INLINE b3QuadWord(const b3Scalar& _x, const b3Scalar& _y,
                             const b3Scalar& _z) {
