...
static b3WarningMessageFunc* b3s_warningMessageFunc =
    b3WarningMessageFuncDefault;
...
void b3EnterProfileZone(const char* name) { (b3s_enterFunc)(name); }
void b3LeaveProfileZone() { (b3s_leaveFunc)(); }
