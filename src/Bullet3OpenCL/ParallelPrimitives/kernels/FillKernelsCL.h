...
static const char*
    fillKernelsCL =
        ...
        "__kernel\n"
        "__attribute__((reqd_work_group_size(64,1,1)))\n"
        "void FillFloatKernel(__global float* dstFloat, 	int "
        "num_elements, float value, const int offset)\n"
        "{\n"
        "	int gIdx = GET_GLOBAL_IDX;\n"
        "	if( gIdx < num_elements )\n"
        "	{\n"
        ...
        "__kernel\n"
        "__attribute__((reqd_work_group_size(64,1,1)))\n"
        "void FillUnsignedIntKernel(__global unsigned int* dstInt, const int "
        "num, const unsigned int value, const int offset)\n"
        "{\n"
        "	int gIdx = GET_GLOBAL_IDX;\n"
        "	if( gIdx < num )\n"
        "	{\n"
