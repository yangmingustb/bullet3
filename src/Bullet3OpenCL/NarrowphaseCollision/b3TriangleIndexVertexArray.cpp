...
b3TriangleIndexVertexArray::b3TriangleIndexVertexArray(
    ...
    int numVertices, b3Scalar* vertexBase, int vertexStride)
    : m_hasAabb(0) {
  b3IndexedMesh mesh;
...
void b3TriangleIndexVertexArray::getLockedVertexIndexBase(
...
void b3TriangleIndexVertexArray::getLockedReadOnlyVertexIndexBase(
...
void b3TriangleIndexVertexArray::setPremadeAabb(
    const b3Vector3& aabbMin, const b3Vector3& aabbMax) const {
  m_aabbMin = aabbMin;
  m_aabbMax = aabbMax;
  m_hasAabb = 1;  // this is intentionally an int see notes in header
}

void b3TriangleIndexVertexArray::getPremadeAabb(b3Vector3* aabbMin,
