...
/// b3ContactCache is a contact point cache, it stays persistent as long as
/// objects are overlapping in the broadphase.
...
b3ContactCache {
  ...
  */
  ...
  static void refreshContactPoints(const b3Transform& trA,
                                   const b3Transform& trB,
                                   struct b3Contact4Data& newContactCache);

  static void removeContactPoint(struct b3Contact4Data & newContactCache,
                                 int i);
};
