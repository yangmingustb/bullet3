...
static const char* rayCastKernelCL =
    ...
    "}\n"
    "bool rayConvex(float4 rayFromLocal, float4 rayToLocal, int numFaces, int "
    "faceOffset,\n"
    "	__global const b3GpuFace* faces, float* hitFraction, float4* "
    "hitNormal)\n"
    "{\n"
    "	rayFromLocal.w = 0.f;\n"
    "	rayToLocal.w = 0.f;\n"
    ...
    "		float fromPlaneDist = "
    "dot(rayFromLocal,face.m_plane)+face.m_plane.w;\n"
    "		float toPlaneDist = "
    "dot(rayToLocal,face.m_plane)+face.m_plane.w;\n"
    "		if (fromPlaneDist<0.f)\n"
    "		{\n"
    "			if (toPlaneDist >= 0.f)\n"
    "			{\n"
    "				float fraction = fromPlaneDist / "
    "(fromPlaneDist-toPlaneDist);\n"
    ...
    "	return result;\n"
    "}\n"
    "bool sphere_intersect(float4 spherePos,  float radius, float4 rayFrom, "
    "float4 rayTo, float* hitFraction)\n"
    "{\n"
    ...
    "			cachedCollidable = "
    "collidables[cachedCollidableIndex];\n"
    "		}\n"
    ...
    "			rayToLocal.w = 0.f;\n"
    "			int numFaces = "
    "convexShapes[cachedCollidable.m_shapeIndex].m_numFaces;\n"
    "			int faceOffset = "
    "convexShapes[cachedCollidable.m_shapeIndex].m_faceOffset;\n"
    "			if (numFaces)\n"
    "			{\n"
    "				if (rayConvex(rayFromLocal, rayToLocal, "
    "numFaces, faceOffset,faces, &hitFraction, &hitNormal))\n"
    "				{\n"
    "					hitBodyIndex = b;\n"
    "					\n"
    "				}\n"
    ...
    "	\n"
    "	atomic_min(&out_firstRayRigidPairIndexPerRay[rayIndex], "
    "rayRigidPairIndex);\n"
    ...
    "b3RayHit* hitResults, \n"
    "								__global int* "
    "firstRayRigidPairIndexPerRay,\n"
    "								__global int* "
    "numRayRigidPairsPerRay,\n"
    "									\n"
    "								__global Body* "
    "bodies,\n"
    "								__global "
    ...
    "	{\n"
    "		int rayRigidPairIndex = pair + "
    "firstRayRigidPairIndexPerRay[i];\n"
    "		int b = rayRigidPairs[rayRigidPairIndex].y;\n"
    "		\n"
    "		if (hitResults[i].m_hitResult2 == b) continue;\n"
    "		\n"
    "		Body body = bodies[b];\n"
    "		Collidable rigidCollidable = "
    "collidables[body.m_collidableIdx];\n"
    "		\n"
    "		float4 pos = body.m_pos;\n"
    "		float4 orn = body.m_quat;\n"
    "		\n"
    ...
    "			int faceOffset = "
    "convexShapes[rigidCollidable.m_shapeIndex].m_faceOffset;\n"
    "			\n"
    "			if (numFaces && rayConvex(rayFromLocal, rayToLocal, "
    "numFaces, faceOffset,faces, &hitFraction, &hitNormal))\n"
    "			{\n"
    "				hitBodyIndex = b;\n"
    "				hitPoint = setInterpolate3(rayFrom, rayTo, "
    "hitFraction);\n"
    "			}\n"
    "		}\n"
    "		\n"
