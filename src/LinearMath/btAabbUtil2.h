...
SIMD_FORCE_INLINE void AabbExpand(btVector3& aabbMin, btVector3& aabbMax,
...
SIMD_FORCE_INLINE bool btRayAabb2(const btVector3& rayFrom,
                                  ...
                                  const btVector3 bounds[2], btScalar& tmin,
                                  btScalar lambda_min, btScalar lambda_max) {
...
SIMD_FORCE_INLINE bool btRayAabb(const btVector3& rayFrom,
                                 ...
                                 const btVector3& aabbMin,
                                 const btVector3& aabbMax, btScalar& param,
                                 btVector3& normal) {
...
SIMD_FORCE_INLINE void btTransformAabb(const btVector3& halfExtents,
                                       btScalar margin, const btTransform& t,
                                       btVector3& aabbMinOut,
                                       btVector3& aabbMaxOut) {
  btVector3 halfExtentsWithMargin =
...
SIMD_FORCE_INLINE unsigned testQuantizedAabbAgainstQuantizedAabb(
  ...
  return static_cast<unsigned int>(btSelect(
