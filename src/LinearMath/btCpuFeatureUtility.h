...
/// Rudimentary btCpuFeatureUtility for CPU features: only report the features
/// that Bullet actually uses (SSE4/FMA3, NEON_HPFP)
  ...
  static int getCpuFeatures() {
...
#ifdef BT_USE_NEON
    {
      ...
      int err = sysctlbyname("hw.optional.neon_hpfp", &hasFeature, &featureSize,
                             NULL, 0);
      if (0 == err && hasFeature) capabilities |= CPU_FEATURE_NEON_HPFP;
    }
#endif  // BT_USE_NEON
