...
class MinitaurSimulatorExample : public CommonExampleInterface {
 ...
 public:
  ...
  virtual void initPhysics() {
    ...
    // when in the debugger, don't crash when a command isn't processed
    // immediately, give it 10 seconds
  ...
  virtual void renderScene() { m_robotSim.renderScene(); }
...
class CommonExampleInterface* MinitaurSimulatorExampleCreateFunc(
