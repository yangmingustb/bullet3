...
class ClothFriction : public CommonRigidBodyBase {
 ...
 public:
  ClothFriction(struct GUIHelperInterface* helper)
      : CommonRigidBodyBase(helper), m_deformableBodySolver(0) {}
...
void ClothFriction::initPhysics() {
...

  {
    ...
    btCollisionShape* groundShape =
        new btBoxShape(btVector3(btScalar(150), btScalar(25.), btScalar(150)));
    ...
    groundTransform.setRotation(
        btQuaternion(btVector3(1, 0, 0), SIMD_PI * 0.1));
  ...
  // create a piece of cloth
  {
    ...
    btSoftBody* psb = btSoftBodyHelpers::CreatePatch(
        ...
        btVector3(+s, h, -s), btVector3(-s, h, +s), btVector3(+s, h, +s), 10,
        10, 0, true);
    ...
    btDeformableMassSpringForce* mass_spring =
        new btDeformableMassSpringForce(10, 1, true);
    ...
    h = .5;
    s = 2;
    btSoftBody* psb2 = btSoftBodyHelpers::CreatePatch(
        getDeformableDynamicsWorld()->getWorldInfo(), btVector3(-s, h, -s),
        btVector3(+s, h, -s), btVector3(-s, h, +s), btVector3(+s, h, +s), 5, 5,
        0, true);
...
class CommonExampleInterface* ClothFrictionCreateFunc(
