...
void DeformableSelfCollision::initPhysics() {
...

  {
    ...
    btCollisionShape* groundShape = new btBoxShape(
        btVector3(btScalar(150.), btScalar(2.5), btScalar(150.)));
...
// create a piece of cloth
{
  ...
  btSoftBody* psb = btSoftBodyHelpers::CreatePatch(
      getDeformableDynamicsWorld()->getWorldInfo(), btVector3(-s, h, -2 * s),
      btVector3(+s, h, -2 * s), btVector3(-s, h, +2 * s),
      btVector3(+s, h, +2 * s), 20, 40,
      //                                                     4,4,
      0, true, 0.0);
  ...
  btDeformableMassSpringForce* mass_spring =
      new btDeformableMassSpringForce(3, 0.2, true);
...
class CommonExampleInterface* DeformableSelfCollisionCreateFunc(
