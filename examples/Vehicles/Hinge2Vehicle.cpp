...
static float maxEngineForce =
    1000.f;  // this should be engine/velocity dependent
...
void Hinge2Vehicle::initPhysics() {
  ...
  m_carChassis =
      localCreateRigidBody(chassisMass, tr, compound);  // chassisShape);
...
btRigidBody* Hinge2Vehicle::localCreateRigidBody(
...
CommonExampleInterface* Hinge2VehicleCreateFunc(
