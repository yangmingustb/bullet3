...
int loadAndRegisterMeshFromFile2(const std::string& fileName,
  ...
  if (b3ImportMeshUtility::loadAndRegisterMeshFromFileInternal(
    ...
    if (meshData.m_textureImage1) {
      textureIndex = renderer->registerTexture(meshData.m_textureImage1,
                                               meshData.m_textureWidth,
                                               meshData.m_textureHeight);
    }

    shapeId = renderer->registerShape(
...
CommonExampleInterface* ImportObjCreateFunc(
