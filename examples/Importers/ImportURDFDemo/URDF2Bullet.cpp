...
// static int
// bodyCollisionFilterMask=btBroadphaseProxy::AllFilter&(~btBroadphaseProxy::CharacterFilter);
...
struct URDF2BulletCachedData {
  ...
  void registerMultiBody(int urdfLinkIndex, class btMultiBody* body,
  ...
  void registerRigidBody(int urdfLinkIndex, class btRigidBody* body,
                         const btTransform& worldTransform, btScalar mass,
                         const btVector3& localInertiaDiagonal,
                         const class btCollisionShape* compound,
                         const btTransform& localInertialFrame) {
...
void ComputeTotalNumberOfJoints(const URDFImporterInterface& u2b,
                                URDF2BulletCachedData& cache, int linkIndex) {
...
void InitURDF2BulletCache(const URDFImporterInterface& u2b,
                          URDF2BulletCachedData& cache, int flags) {
...
void processContactParameters(const URDFLinkContactInfo& contactInfo,
...
btTransform ConvertURDF2BulletInternal(
    ...
    btMultiBodyDynamicsWorld* world1, bool createMultiBody,
    const char* pathPrefix, int flags,
    UrdfVisualShapeCache* cachedLinkGraphicsShapesIn,
    UrdfVisualShapeCache* cachedLinkGraphicsShapesOut, bool recursive) {
  ...
  btCompoundShape* tmpShape = u2b.convertLinkCollisionShapes(
  ...
  int graphicsIndex;
  {
    ...
    if (cachedLinkGraphicsShapesIn &&
        cachedLinkGraphicsShapesIn->m_cachedUrdfLinkVisualShapeIndices.size() >
            (mbLinkIndex + 1)) {
      graphicsIndex = cachedLinkGraphicsShapesIn
                          ->m_cachedUrdfLinkVisualShapeIndices[mbLinkIndex + 1];
      ...
      graphicsIndex = u2b.convertLinkVisualShapes(urdfLinkIndex, pathPrefix,
                                                  localInertialFrame);
      if (cachedLinkGraphicsShapesOut) {
        cachedLinkGraphicsShapesOut->m_cachedUrdfLinkVisualShapeIndices
            .push_back(graphicsIndex);
        UrdfMaterialColor matColor;
...
*/
    ...
    if (!createMultiBody) {
      btRigidBody* body =
          creation.allocateRigidBody(urdfLinkIndex, mass, localInertiaDiagonal,
                                     inertialFrameInWorldSpace, compoundShape);
      ...
      creation.createRigidBodyGraphicsInstance2(urdfLinkIndex, body, color2,
                                                specular, graphicsIndex);
      cache.registerRigidBody(urdfLinkIndex, body, inertialFrameInWorldSpace,
                              mass, localInertiaDiagonal, compoundShape,
                              localInertialFrame);

      // untested:
      // u2b.convertLinkVisualShapes2(linkIndex,urdfLinkIndex,pathPrefix,localInertialFrame,body);
    } else {
      if (cache.m_bulletMultiBody == 0) {
        bool isFixedBase = (mass == 0);  // todo: figure out when base is fixed
        int totalNumJoints = cache.m_totalNumJoints1;
        cache.m_bulletMultiBody = creation.allocateMultiBody(
            urdfLinkIndex, totalNumJoints, mass, localInertiaDiagonal,
        ...
        cache.registerMultiBody(
            urdfLinkIndex, cache.m_bulletMultiBody, inertialFrameInWorldSpace,
            mass, localInertiaDiagonal, compoundShape, localInertialFrame);
      }
    }
    ...
    if (hasParentJoint) {
      ...
      switch (jointType) {
        case URDFSphericalJoint: {
          if (createMultiBody) {
            ...
            cache.m_bulletMultiBody->setupSpherical(
                mbLinkIndex, mass, localInertiaDiagonal, mbParentIndex,
        ...
        case URDFPlanarJoint: {
          if (createMultiBody) {
            ...
            cache.m_bulletMultiBody->setupPlanar(
                mbLinkIndex, mass, localInertiaDiagonal, mbParentIndex,
                parentRotToThis,
                quatRotate(offsetInB.getRotation(), jointAxisInJointSpace),
                offsetInA.getOrigin(), disableParentCollision);
          } else {
#if 0
        ...
        case URDFFixedJoint: {
          if ((jointType == URDFFloatingJoint) ||
          ...
          if (createMultiBody) {
            ...
            // backward compatibility
            if (flags & CUF_RESERVED) {
              dof6 = creation.createFixedJoint(urdfLinkIndex, *parentRigidBody,
                                               *linkRigidBody, offsetInA,
                                               offsetInB);
            } else {
              dof6 = creation.createFixedJoint(urdfLinkIndex, *linkRigidBody,
                                               *parentRigidBody, offsetInB,
                                               offsetInA);
            }
            if (enableConstraints) world1->addConstraint(dof6, true);
          }
          break;
        }
        ...
        case URDFRevoluteJoint: {
          ...
          if (createMultiBody) {
            cache.m_bulletMultiBody->setupRevolute(
                ...
                parentRotToThis,
                quatRotate(offsetInB.getRotation(), jointAxisInJointSpace),
                offsetInA.getOrigin(), -offsetInB.getOrigin(),
                disableParentCollision);

            if (jointType == URDFRevoluteJoint &&
                jointLowerLimit <= jointUpperLimit) {
              // std::string name = u2b.getLinkName(urdfLinkIndex);
              // printf("create btMultiBodyJointLimitConstraint for revolute
              // link name=%s urdf link index=%d (low=%f, up=%f)\n",
            ...
            if (jointType == URDFRevoluteJoint &&
              ...
              if (flags & CUF_RESERVED) {
                dof6 = creation.createRevoluteJoint(
                    urdfLinkIndex, *parentRigidBody, *linkRigidBody, offsetInA,
                    offsetInB, jointAxisInJointSpace, jointLowerLimit,
                    jointUpperLimit);
              } else {
                dof6 = creation.createRevoluteJoint(
                    urdfLinkIndex, *linkRigidBody, *parentRigidBody, offsetInB,
                    offsetInA, jointAxisInJointSpace, jointLowerLimit,
                    jointUpperLimit);
              }
            } else {
              ...
              if (flags & CUF_RESERVED) {
                dof6 = creation.createRevoluteJoint(
                    urdfLinkIndex, *parentRigidBody, *linkRigidBody, offsetInA,
                    offsetInB, jointAxisInJointSpace, 1, -1);
              } else {
                dof6 = creation.createRevoluteJoint(
                    urdfLinkIndex, *linkRigidBody, *parentRigidBody, offsetInB,
                    offsetInA, jointAxisInJointSpace, 1, -1);
              }
            }
        ...
        case URDFPrismaticJoint: {
          ...
          if (createMultiBody) {
            cache.m_bulletMultiBody->setupPrismatic(
                ...
                parentRotToThis,
                quatRotate(offsetInB.getRotation(), jointAxisInJointSpace),
                offsetInA.getOrigin(),  // parent2joint.getOrigin(),
                -offsetInB.getOrigin(), disableParentCollision);

            if (jointLowerLimit <= jointUpperLimit) {
              // std::string name = u2b.getLinkName(urdfLinkIndex);
              // printf("create btMultiBodyJointLimitConstraint for prismatic
              // link name=%s urdf link index=%d (low=%f, up=%f)\n",
              // name.c_str(), urdfLinkIndex, jointLowerLimit,jointUpperLimit);
            ...
            btGeneric6DofSpring2Constraint* dof6 =
                creation.createPrismaticJoint(urdfLinkIndex, *parentRigidBody,
                                              *linkRigidBody, offsetInA,
                                              offsetInB, jointAxisInJointSpace,
                                              jointLowerLimit, jointUpperLimit);
    ...
    if (createMultiBody) {
      ...
      {
        btMultiBodyLinkCollider* col = creation.allocateMultiBodyLinkCollider(
            urdfLinkIndex, mbLinkIndex, cache.m_bulletMultiBody);
        ...
        // simulator will do this
        // when syncing the btMultiBody link transforms to the
        ...
        int collisionFlags =
            u2b.getCollisionGroupAndMask(urdfLinkIndex, colGroup, colMask);
        ...
        }
        {
          ...
          creation.createCollisionObjectGraphicsInstance2(
              urdfLinkIndex, col, color2, specularColor);
        }
        {
          B3_PROFILE("convertLinkVisualShapes2");
          u2b.convertLinkVisualShapes2(mbLinkIndex, urdfLinkIndex, pathPrefix,
                                       localInertialFrame, col,
                                       u2b.getBodyUniqueId());
        }
        URDFLinkContactInfo contactInfo;
        u2b.getLinkContactInfo(urdfLinkIndex, contactInfo);
      ...
      u2b.convertLinkVisualShapes2(-1, urdfLinkIndex, pathPrefix,
                                   localInertialFrame, linkRigidBody,
                                   u2b.getBodyUniqueId());
    }
  }
  ...
  if (recursive) {
    for (int i = 0; i < numChildren; i++) {
      ...
      ConvertURDF2BulletInternal(
          u2b, creation, cache, urdfChildLinkIndex, linkTransformInWorldSpace,
          world1, createMultiBody, pathPrefix, flags,
          cachedLinkGraphicsShapesIn, cachedLinkGraphicsShapesOut, recursive);
    }
  }
...
void GetAllIndices(const URDFImporterInterface& u2b,
                   URDF2BulletCachedData& cache, int urdfLinkIndex,
                   int parentIndex,
...
void ConvertURDF2Bullet(const URDFImporterInterface& u2b,
  ...
  if (recursive) {
    ConvertURDF2BulletInternal(
        u2b, creation, cache, urdfLinkIndex, rootTransformInWorldSpace, world1,
        createMultiBody, pathPrefix, flags, cachedLinkGraphicsShapes,
    ...
    for (int i = 0; i < allIndices.size(); i++) {
      ...
      btTransform parentTr = parentIndex >= 0 ? parentTransforms[parentIndex]
                                              : rootTransformInWorldSpace;
      btTransform tr = ConvertURDF2BulletInternal(
          u2b, creation, cache, urdfLinkIndex, parentTr, world1,
          createMultiBody, pathPrefix, flags, cachedLinkGraphicsShapes,
          &cachedLinkGraphicsShapesOut, recursive);
  ...
  if (cachedLinkGraphicsShapes &&
      cachedLinkGraphicsShapesOut.m_cachedUrdfLinkVisualShapeIndices.size() >
