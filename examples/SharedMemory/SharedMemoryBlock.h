...
struct SharedMemoryBlock {
  ...
  // m_bulletStreamDataServerToClient is used to send (debug) data from server
  // to client, for
  // example to provide all details of a multibody including joint/link names,
  // after loading a URDF file.
  char m_bulletStreamDataServerToClientRefactor
