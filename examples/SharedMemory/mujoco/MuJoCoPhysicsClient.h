...
/// PhysicsDirect executes the commands directly, without transporting them or
/// having a separate server executing commands
class MuJoCoPhysicsClient : public PhysicsClient {
 ...
 public:
  MuJoCoPhysicsClient(class PhysicsCommandProcessorInterface* physSdk,
                      bool passSdkOwnership);
  ...
  virtual bool getCachedUserData(int bodyUniqueId, int linkIndex,
                                 int userDataId,
  ...
  virtual void getUserDataInfo(int bodyUniqueId, int linkIndex,
                               int userDataIndex, const char** keyOut,
                               int* userDataIdOut) const;
