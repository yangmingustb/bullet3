...
p.connect(p.GUI)
pluginUid =
p.loadPlugin("E:/develop/bullet3/bin/pybullet_testplugin_vs2010_x64_debug.dll")
commandUid = 0
argument = "plane.urdf"
...
B3_SHARED_API int preTickPluginCallback_testPlugin(
    struct b3PluginContext* context) {
  return 0;
}

B3_SHARED_API int postTickPluginCallback_testPlugin(
    struct b3PluginContext* context) {
...
B3_SHARED_API int executePluginCommand_testPlugin(
    struct b3PluginContext* context,
