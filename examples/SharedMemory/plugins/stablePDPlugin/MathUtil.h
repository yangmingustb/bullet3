...
class cMathUtil {
 public:
  ...
  static tMatrix RotateMat(
      const tVector& euler);  // euler angles order rot(Z) * rot(Y) * rot(X)
  ...
  static tVector CalcQuaternionVel(const tQuaternion& q0, const tQuaternion& q1,
                                   double dt);
  ...
  static bool ContainsAABBXZ(const tVector& pt, const tVector& aabb_min,
                             const tVector& aabb_max);
  static bool ContainsAABBXZ(const tVector& aabb_min0, const tVector& aabb_max0,
  ...
  static void CalcAABBIntersection(const tVector& aabb_min0,
                                   ...
                                   tVector& out_max);
  static void CalcAABBUnion(const tVector& aabb_min0, const tVector& aabb_max0,
                            const tVector& aabb_min1, const tVector& aabb_max1,
                            tVector& out_min, tVector& out_max);
  static bool IntersectAABB(const tVector& aabb_min0, const tVector& aabb_max0,
                            const tVector& aabb_min1, const tVector& aabb_max1);
