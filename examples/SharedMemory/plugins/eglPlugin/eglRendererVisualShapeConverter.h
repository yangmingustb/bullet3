...
struct EGLRendererVisualShapeConverter : public UrdfRenderingInterface {
  ...
  virtual int addVisualShape(b3VisualShapeData* visualShape,
                             struct CommonFileIOInterface* fileIO) {
    return -1;
  }
  ...
  void copyCameraImageDataGL(unsigned char* pixelsRGBA,
                             int rgbaBufferSizeInPixels, float* depthBuffer,
                             int depthBufferSizeInPixels,
                             int* segmentationMaskBuffer,
                             int segmentationMaskSizeInPixels,
  ...
  virtual void syncTransform(int shapeUid,
