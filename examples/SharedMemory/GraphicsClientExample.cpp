...
GraphicsClientExample::GraphicsClientExample(GUIHelperInterface* helper,
                                             int options)
    : m_guiHelper(helper), m_waitingForServer(false), m_testBlock1(0) {
#ifdef _WIN32
...
class CommonExampleInterface* GraphicsClientCreateFunc(
    struct CommonExampleOptions& options) {
  GraphicsClientExample* example =
      new GraphicsClientExample(options.m_guiHelper, options.m_option);
