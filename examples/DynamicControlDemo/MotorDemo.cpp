/*
Bullet Continuous Collision Detection and Physics Library Copyright (c) 2007
Erwin Coumans
Motor Demo
...
class MotorDemo : public CommonRigidBodyBase {
 ...
 public:
  MotorDemo(struct GUIHelperInterface* helper) : CommonRigidBodyBase(helper) {}
...
class CommonExampleInterface* MotorControlCreateFunc(
