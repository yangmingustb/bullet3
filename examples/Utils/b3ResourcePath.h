...
typedef bool (*PFN_FIND_FILE)(void* userPointer, const char* orgFileName,
...
class b3ResourcePath {
 public:
  ...
  static int findResourcePath(const char* resourceName, char* resourcePathOut,
                              int resourcePathMaxNumBytes,
                              PFN_FIND_FILE findFile, void* userPointer = 0);
