...
bool b3ProfileIterator::Is_Done(void) { return CurrentChild == NULL; }
 ...
 *=============================================================================================*/
void b3ProfileManager::Increment_Frame_Counter(void) { FrameCounter++; }

/***********************************************************************************************
 * b3ProfileManager::Get_Time_Since_Reset -- returns the elapsed time since last
 *reset         *
 *=============================================================================================*/
...
void b3ProfileManager::dumpRecursive(b3ProfileIterator* profileIterator,
                                     int spacing) {
  ...
  float accumulated_time = 0,
        parent_time = profileIterator->Is_Root()
                          ? b3ProfileManager::Get_Time_Since_Reset()
  ...
  for (i = 0; !profileIterator->Is_Done(); i++, profileIterator->Next()) {
    ...
    float fraction = parent_time > B3_EPSILON
...
void b3ProfileManager::dumpRecursive(FILE* f,
