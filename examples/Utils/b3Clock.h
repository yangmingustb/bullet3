...
/// The b3Clock is a portable basic clock that measures accurate time in
...
class b3Clock {
 public:
  ...
  /// Resets the initial reference time. If zeroReference is true, will set
  /// reference to absolute 0.
