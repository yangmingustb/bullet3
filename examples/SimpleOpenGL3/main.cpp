...
int main(int argc, char* argv[]) {
  {
    ...
    do {
      ...
      app->m_primRenderer->drawTexturedRect(
          100, 200, gWidth / 2 - 50, gHeight / 2 - 50, color, 0, 0, 1, 1, true);
      ...
      app->drawText3D(bla, position2, orientation, color, 1,
      ...
      app->drawText3D(bla, position2, orientation, green, 1,
                      CommonGraphicsApp::eDrawText3D_TrueType |
                          CommonGraphicsApp::eDrawText3D_OrtogonalFaceCamera);
      ...
      app->drawText3D(bla, position2, orn, blue, 1,
                      CommonGraphicsApp::eDrawText3D_TrueType);
