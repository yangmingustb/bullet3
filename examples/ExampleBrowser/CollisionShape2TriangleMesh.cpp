        ...
        for (int triangleIndex = 0; triangleIndex < numfaces; triangleIndex++) {
          ...
          for (int j = 2; j >= 0; j--) {
            ...
            if (type == PHY_FLOAT) {
              ...
              triangleVerts[j] =
                  btVector3(graphicsbase[0] * trimeshScaling.getX(),
              ...
              triangleVerts[j] =
                  btVector3(btScalar(graphicsbase[0] * trimeshScaling.getX()),
          ...
          btVector3 triNormal = (triangleVerts[1] - triangleVerts[0])
                                    .cross(triangleVerts[2] - triangleVerts[0]);
          ...
          if (pol) {
...

            {
              ...
              for (int t = 0; t < hull->numTriangles(); t++) {
                ...
                btVector3 pos0 =
                    parentTransform * hull->getVertexPointer()[index0];
                btVector3 pos1 =
                    parentTransform * hull->getVertexPointer()[index1];
                btVector3 pos2 =
                    parentTransform * hull->getVertexPointer()[index2];
                ...
                for (int v = 0; v < 3; v++) {
                  ...
                  btVector3 pos =
                      parentTransform * hull->getVertexPointer()[index];
                  indicesOut.push_back(vertexPositions.size());
                  vertexPositions.push_back(pos);
                  vertexNormals.push_back(triNormal);
                }
        ...
        if (collisionShape->isCompound()) {
          ...
          for (int i = 0; i < compound->getNumChildShapes(); i++) {
            btTransform childWorldTrans =
                parentTransform * compound->getChildTransform(i);
            CollisionShape2TriangleMesh(compound->getChildShape(i),
                                        childWorldTrans, vertexPositions,
