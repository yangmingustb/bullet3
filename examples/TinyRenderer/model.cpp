...
void Model::setDiffuseTextureFromData(unsigned char *textureImage,
  ...
  color.bytespp = 3;
  {
    ...
    memcpy(diffusemap_.buffer(), textureImage,
           textureHeight * textureWidth * 3);
  }
  {
...
void Model::addVertex(float x, float y, float z, float normalX, float normalY,
