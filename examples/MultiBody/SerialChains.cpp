...
class SerialChains : public CommonMultiBodyBase {
 public:
  ...
  btMultiBody* createFeatherstoneMultiBody(
  ...
  void createGround(const btVector3& halfExtents = btVector3(50, 50, 50),
                    btScalar zOffSet = btScalar(-1.55));
...
void SerialChains::initPhysics() {
  ...
  m_dynamicsWorld->getSolverInfo().m_globalCfm =
      btScalar(1e-4);  // todo: what value is good?
  ...
  btMultiBody* mbC1 = createFeatherstoneMultiBody(
      world, numLinks, btVector3(-0.4f, 3.f, 0.f), linkHalfExtents,
      baseHalfExtents, spherical, g_fixedBase);
  btMultiBody* mbC2 = createFeatherstoneMultiBody(
...
btMultiBody* SerialChains::createFeatherstoneMultiBody(
    btMultiBodyDynamicsWorld* pWorld, int numLinks,
    const btVector3& basePosition, const btVector3& baseHalfExtents,
    const btVector3& linkHalfExtents, bool spherical, bool fixedBase) {
  // init the base
  ...
  btMultiBody* pMultiBody =
      new btMultiBody(numLinks, baseMass, baseInertiaDiag, fixedBase, canSleep);
...
void SerialChains::createGround(const btVector3& halfExtents,
                                btScalar zOffSet) {
...
void SerialChains::addColliders(btMultiBody* pMultiBody,
