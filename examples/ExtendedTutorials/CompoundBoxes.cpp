...
void CompoundBoxesExample::initPhysics() {
...

  {
    ...
    for (int i = 0; i < compoundShape->getNumChildShapes(); i++)
      compound2->addChildShape(
          compoundShape->getChildTransform(i) * principal.inverse(),
...
void CompoundBoxesExample::renderScene() { CommonRigidBodyBase::renderScene(); }

CommonExampleInterface* ET_CompoundBoxesCreateFunc(
