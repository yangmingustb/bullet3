...

  {
    ...
    for (int i = 0; i < TOTAL_BOXES; ++i) {
      startTransform.setOrigin(
          btVector3(btScalar(0), btScalar(20 + i * 2), btScalar(0)));
...
void MultipleBoxesExample::renderScene() { CommonRigidBodyBase::renderScene(); }

CommonExampleInterface* ET_MultipleBoxesCreateFunc(
