...
class SW_And_OpenGLGuiHelper : public OpenGLGuiHelper {
 ...
 public:
  SW_And_OpenGLGuiHelper(CommonGraphicsApp* glApp, bool useOpenGL2, int swWidth,
                         int swHeight, GLPrimitiveRenderer* primRenderer)
  ...
  virtual int registerGraphicsInstance(int shapeIndex, const float* position,
                                       ...
                                       const float* color,
                                       const float* scaling) {
    int instanceId = OpenGLGuiHelper::registerGraphicsInstance(
  ...
  virtual void render(const btDiscreteDynamicsWorld* rbWorld) {
    ...
    m_primRenderer->drawTexturedRect(0, 0, m_swWidth, m_swHeight, color, 0, 0,
                                     1, 1, true);
  }
...
int main(int argc, char* argv[]) {
  SimpleOpenGL3App* app = new SimpleOpenGL3App(
      "Standalone Example (Software Renderer, TinyRenderer)", 1024, 768, true);
  int textureWidth = 640;
  int textureHeight = 480;

  SW_And_OpenGLGuiHelper gui(app, false, textureWidth, textureHeight,
                             app->m_primRenderer);
