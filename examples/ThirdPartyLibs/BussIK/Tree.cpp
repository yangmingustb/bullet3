...
Node* Tree::GetJoint(int index) { return SearchJoint(root, index); }
...
Node* Tree::GetEffector(int index) { return SearchEffector(root, index); }
...
void Tree::Compute(void) { ComputeTree(root); }
...
void Tree::Init(void) { InitTree(root); }
...
void Tree::UnFreeze(void) { UnFreezeTree(root); }
