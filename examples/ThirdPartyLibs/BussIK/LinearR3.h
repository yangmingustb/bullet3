...
class VectorR3 {
 ...
 public:
  ...
  VectorR3& SetFromHg(
      const VectorR4&);  // Convert homogeneous VectorR4 to VectorR3
  VectorR3& SetZero() {
    x = 0.0;
    y = 0.0;
    z = 0.0;
  ...
  VectorR3& RotateUnitInDirection(
      const VectorR3& dir);             // rotate in direction dir
...
inline VectorR3 operator*(const VectorR3& u,
                          const VectorR3& v);  // Cross Product
...
inline double DistSq(const VectorR3& u, const VectorR3& v) {
  return u.DistSq(v);
}
...
inline VectorR3 ToVectorR3(const Quaternion& q) { return VectorR3().Set(q); }
...
class Matrix3x3 {
 ...
 public:
  inline Matrix3x3();
  inline Matrix3x3(const VectorR3&, const VectorR3&,
                   const VectorR3&);  // Sets by columns!
  inline Matrix3x3(double, double, double, double, double, double, double,
                   double, double);  // Sets by columns
  ...
  inline void Set(double, double, double, double, double, double, double,
                  double, double);
  inline void SetByRows(double, double, double, double, double, double, double,
                        double, double);
...
class Matrix3x4 {
 ...
 public:
  ...
  Matrix3x4(double, double, double, double, double, double, double, double,
  ...
  void Set(const Matrix3x3&,
           const VectorR3&);  // Set to the matrix plus 4th column
  ...
  void Set(double, double, double, double, double, double, double, double,
           double, double, double, double);  // Sets by columns
  void Set3x3(double, double, double, double, double, double, double, double,
              double);  // Sets by columns
  void SetByRows(double, double, double, double, double, double, double, double,
...
class LinearMapR3 : public Matrix3x3 {
 public:
  ...
  LinearMapR3(double, double, double, double, double, double, double, double,
              double);  // Sets by columns
...
class AffineMapR3 : public Matrix3x4 {
 public:
  AffineMapR3();
  AffineMapR3(double, double, double, double, double, double, double, double,
              double, double, double, double);  // Sets by columns
  AffineMapR3(const VectorR3&, const VectorR3&, const VectorR3&,
              const VectorR3&);
...
class RotationMapR3 : public Matrix3x3 {
 public:
  ...
  RotationMapR3(double, double, double, double, double, double, double, double,
                double);

  RotationMapR3& Set(const Quaternion&);
  RotationMapR3& Set(const VectorR3&,
                     double theta);  // Set rotation axis and angle
  ...
  RotationMapR3 Transpose() const {
    return Inverse();
  };                              // Returns the transpose
  RotationMapR3 Inverse() const;  // Returns inverse
  RotationMapR3& Invert();        // Converts into inverse.
  VectorR3 Solve(
      const VectorR3&) const;  // Returns solution	// Was named Invert

  bool ToAxisAndAngle(VectorR3* u,
                      double* theta) const;  // returns unit vector u and angle
};
...
class RigidMapR3 : public Matrix3x4 {
 public:
  RigidMapR3();
  RigidMapR3(const VectorR3&, const VectorR3&, const VectorR3&,
             const VectorR3&);
  RigidMapR3(double, double, double, double, double, double, double, double,
             double, double, double, double);
  RigidMapR3(const Matrix3x3&, const VectorR3&);

  RigidMapR3& Set(const Matrix3x3&,
                  const VectorR3&);  // Set to RotationMap & Vector
  RigidMapR3& SetTranslationPart(const VectorR3&);  // Set the translation part
  RigidMapR3& SetTranslationPart(double, double,
                                 double);         // Set the translation part
  RigidMapR3& SetRotationPart(const Matrix3x3&);  // Set the rotation part
  RigidMapR3& SetRotationPart(const Quaternion&);
  RigidMapR3& SetRotationPart(const VectorR3&,
                              double theta);  // Set rotation axis and angle
  RigidMapR3& SetRotationPart(const VectorR3&, double sintheta,
                              double costheta);
  ...
  bool CalcGlideRotation(VectorR3* u, VectorR3* v, double* glideDist,
...
inline VectorR3&
VectorR3::MakeUnit()  // Convert to unit vector (or leave zero).
{
  double nSq = NormSq();
  if (nSq != 0.0) {
    *this /= sqrt(nSq);
...
inline VectorR3 operator*(const VectorR3& u,
                          const VectorR3& v)  // Cross Product
{
  return (VectorR3(u.y * v.z - u.z * v.y, u.z * v.x - u.x * v.z,
                   u.x * v.y - u.y * v.x));
}
...
inline VectorR3& VectorR3::ArrayProd(
    const VectorR3& v)  // Component-wise Product
{
  x *= v.x;
  y *= v.y;
  z *= v.z;
...
inline VectorR3::VectorR3(const VectorHgR3& uH) : x(uH.x), y(uH.y), z(uH.z) {
  *this /= uH.w;
}
...
inline VectorR3 Interpolate(const VectorR3& start, const VectorR3& end,
                            double a) {
  VectorR3 ret;
...
inline Matrix3x3::Matrix3x3(double a11, double a21, double a31, double a12,
                            double a22, double a32, double a13, double a23,
                            double a33)
...
inline void Matrix3x3::Set3x3(
    const Matrix3x4& A)  // Set to the 3x3 part of the matrix.
{
  m11 = A.m11;
  m21 = A.m21;
  m31 = A.m31;
...
inline void Matrix3x3::Set(double a11, double a21, double a31, double a12,
                           double a22, double a32, double a13, double a23,
                           double a33)
// Values specified in column order!!!
{
...
inline void Matrix3x3::SetByRows(double a11, double a12, double a13, double a21,
...
inline VectorR3 Matrix3x3::Column1() const { return (VectorR3(m11, m21, m31)); }

inline VectorR3 Matrix3x3::Column2() const { return (VectorR3(m12, m22, m32)); }

inline VectorR3 Matrix3x3::Column3() const { return (VectorR3(m13, m23, m33)); }

inline VectorR3 Matrix3x3::Row1() const { return (VectorR3(m11, m12, m13)); }

inline VectorR3 Matrix3x3::Row2() const { return (VectorR3(m21, m22, m23)); }

inline VectorR3 Matrix3x3::Row3() const { return (VectorR3(m31, m32, m33)); }
...
inline Matrix3x4::Matrix3x4(double a11, double a21, double a31, double a12,
                            double a22, double a32, double a13, double a23,
                            double a33, double a14, double a24,
                            double a34) {  // Values in COLUMN order!
  m11 = a11;                               // Row 1
  m12 = a12;
  m13 = a13;
  m14 = a14;
...
inline void Matrix3x4::Set(
    const Matrix3x3& A, const VectorR3& t)  // Set to the matrix plus 4th column
{
  m11 = A.m11;
  m21 = A.m21;
  m31 = A.m31;
...
inline void Matrix3x4::Set(double a11, double a21, double a31, double a12,
                           double a22, double a32, double a13, double a23,
                           double a33, double a14, double a24, double a34)
// Values specified in column order!!!
{
  m11 = a11;  // Row 1
  m12 = a12;
...
inline void Matrix3x4::Set3x3(double a11, double a21, double a31, double a12,
                              double a22, double a32, double a13, double a23,
                              double a33)
// Values specified in column order!!!
{
...
inline VectorR3 Matrix3x4::Column1() const { return (VectorR3(m11, m21, m31)); }

inline VectorR3 Matrix3x4::Column2() const { return (VectorR3(m12, m22, m32)); }

inline VectorR3 Matrix3x4::Column3() const { return (VectorR3(m13, m23, m33)); }

inline VectorR3 Matrix3x4::Column4() const { return (VectorR3(m14, m24, m34)); }
...
inline Matrix3x4& Matrix3x4::ApplyYRotationLeft(double costheta,
                                                double sintheta) {
  double tmp;
...
inline void Matrix3x4::Transform3x3Transpose(const VectorR3& src,
                                             VectorR3* dest) const {
...
inline LinearMapR3::LinearMapR3(double a11, double a21, double a31, double a12,
                                double a22, double a32, double a13, double a23,
                                double a33)
    // Values specified in column order!!!
    : Matrix3x3(a11, a21, a31, a12, a22, a32, a13, a23, a33) {}

inline LinearMapR3::LinearMapR3(const Matrix3x3& A) : Matrix3x3(A) {}

inline void LinearMapR3::SetZero() { Matrix3x3::SetZero(); }
...
inline LinearMapR3 operator-(const LinearMapR3& A) {
  return (LinearMapR3(-A.m11, -A.m21, -A.m31, -A.m12, -A.m22, -A.m32, -A.m13,
                      -A.m23, -A.m33));
}
...
inline LinearMapR3 operator*(const LinearMapR3& A, double b) {
  return (LinearMapR3(A.m11 * b, A.m21 * b, A.m31 * b, A.m12 * b, A.m22 * b,
                      A.m32 * b, A.m13 * b, A.m23 * b, A.m33 * b));
}
...
inline LinearMapR3 operator/(const LinearMapR3& A, double b) {
  double bInv = 1.0 / b;
  return (LinearMapR3(A.m11 * bInv, A.m21 * bInv, A.m31 * bInv, A.m12 * bInv,
                      A.m22 * bInv, A.m32 * bInv, A.m13 * bInv, A.m23 * bInv,
                      A.m33 * bInv));
}
...
inline LinearMapR3& LinearMapR3::operator*=(
    const Matrix3x3& B)  // Matrix product
{
...
inline AffineMapR3::AffineMapR3(double a11, double a21, double a31, double a12,
                                double a22, double a32, double a13, double a23,
                                double a33, double a14, double a24,
                                double a34) {  // Values in COLUMN order!
  m11 = a11;                                   // Row 1
...
inline void AffineMapR3::SetIdentity() { Matrix3x4::SetIdentity(); }

inline void AffineMapR3::SetZero() { Matrix3x4::SetZero(); }
...
inline AffineMapR3 operator+(const AffineMapR3& A, const Matrix3x3& B) {
  return (AffineMapR3(A.m11 + B.m11, A.m21 + B.m21, A.m31 + B.m31,
                      A.m12 + B.m12, A.m22 + B.m22, A.m32 + B.m32,
                      A.m13 + B.m13, A.m23 + B.m23, A.m33 + B.m33, A.m14, A.m23,
                      A.m34));
}
...
inline AffineMapR3 operator*(const AffineMapR3& A, double b) {
  return (AffineMapR3(A.m11 * b, A.m21 * b, A.m31 * b, A.m12 * b, A.m22 * b,
                      A.m32 * b, A.m13 * b, A.m23 * b, A.m33 * b, A.m14 * b,
                      A.m24 * b, A.m34 * b));
}
...
inline AffineMapR3 operator/(const AffineMapR3& A, double b) {
  double bInv = 1.0 / b;
  return (AffineMapR3(A.m11 * bInv, A.m21 * bInv, A.m31 * bInv, A.m12 * bInv,
                      A.m22 * bInv, A.m32 * bInv, A.m13 * bInv, A.m23 * bInv,
                      A.m33 * bInv, A.m14 * bInv, A.m24 * bInv, A.m34 * bInv));
}
...
inline RotationMapR3::RotationMapR3(double a11, double a21, double a31,
...
inline VectorR3 RotationMapR3::Solve(
    const VectorR3& u) const  // Returns solution
{
...
inline RotationMapR3& RotationMapR3::operator*=(
    const RotationMapR3& B)  // Matrix product
{
  OperatorTimesEquals(B);
  return (*this);
}
...
inline RigidMapR3::RigidMapR3(double a11, double a21, double a31, double a12,
                              double a22, double a32, double a13, double a23,
                              double a33, double a14, double a24, double a34)
    // Values specified in column order!!!
    : Matrix3x4(a11, a21, a31, a12, a22, a32, a13, a23, a33, a14, a24, a34) {}

inline RigidMapR3::RigidMapR3(const Matrix3x3& A,
                              const VectorR3& u)  // Set to RotationMap & Vector
    : Matrix3x4(A, u) {}

inline RigidMapR3& RigidMapR3::Set(
    const Matrix3x3& A, const VectorR3& u)  // Set to RotationMap & Vector
{
  Matrix3x4::Set(A, u);
  return *this;
}

inline RigidMapR3& RigidMapR3::SetTranslationPart(
    const VectorR3& u)  // Set the translation part
{
  SetColumn4(u);
  return *this;
}
...
inline RigidMapR3& RigidMapR3::SetTranslationPart(
    double x, double y, double z)  // Set the translation part
{
  SetColumn4(x, y, z);
  return *this;
}

inline RigidMapR3& RigidMapR3::SetRotationPart(
    const Matrix3x3& A)  // Set the rotation part
{
  Matrix3x4::Set3x3(A);
  return *this;
}

inline RigidMapR3& RigidMapR3::operator*=(
    const RotationMapR3& B)  // Composition
{
  OperatorTimesEquals(B);
  return (*this);
}
...
inline RigidMapR3 RigidMapR3::Inverse() const  // Returns inverse
{
  ...
  return (RigidMapR3(m11, m12, m13,  // In column order!
                     m21, m22, m23, m31, m32, m33, new14, new24, new34));
}
...
inline LinearMapR3 VectorProjectMap(const VectorR3& u) {
  ...
  double b = u.x * u.z;
  double c = u.y * u.z;
  return (LinearMapR3(u.x * u.x, a, b, a, u.y * u.y, c, b, c, u.z * u.z));
}
...
inline LinearMapR3 PlaneProjectMap(const VectorR3& w) {
  ...
  double b = -w.x * w.z;
  double c = -w.y * w.z;
  return (LinearMapR3(1.0 - w.x * w.x, a, b, a, 1.0 - w.y * w.y, c, b, c,
                      1.0 - w.z * w.z));
}

// PlaneProjectMap returns map projecting onto a given plane.
//		The plane is the plane containing the two orthonormal vectors
//u,v.
...
inline LinearMapR3 PlaneProjectMap(const VectorR3& u, const VectorR3& v) {
  ...
  return (LinearMapR3(u.x * u.x + v.x * v.x, a, b, a, u.y * u.y + u.y * u.y, c,
                      b, c, u.z * u.z + v.z * v.z));
}
