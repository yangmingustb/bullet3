...
#define XkbActionSetCtrls(a, c)                                                \
  (((a)->ctrls3 = (((c) >> 24) & 0xff)), ((a)->ctrls2 = (((c) >> 16) & 0xff)), \
   ((a)->ctrls1 = (((c) >> 8) & 0xff)), ((a)->ctrls0 = ((c)&0xff)))
#define XkbActionCtrls(a)                                                      \
  ((((unsigned int)(a)->ctrls3) << 24) | (((unsigned int)(a)->ctrls2) << 16) | \
...
#define XkbSARedirectSetVMods(a, m) \
  (((a)->vmods_mask1 = (((m) >> 8) & 0xff)), ((a)->vmods_mask0 = ((m)&0xff)))
