 ...
 * decomposition to determine whether a system of equations
  ...
  *
  * \b Performance: for best performance, it is recommended to use a
 * column-major storage format
  * with the Lower triangular part (the default), or, equivalently, a row-major
 * storage format
  * with the Upper triangular part. Otherwise, you might get a 20% slowdown for
 ...
 * _UpLo) triangular part of A is considered.
