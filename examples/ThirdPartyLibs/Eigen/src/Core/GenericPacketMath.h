 ...
 * *from and
  * replicated to form:
 * {from[0],from[0],from[0],from[0],from[1],from[1],from[1],from[1]}
 ...
 * packet of \a vec[i] */
template <typename Packet>
EIGEN_DEVICE_FUNC inline Packet preduxp(const Packet* vecs) {
  return vecs[0];
}
...
/** \internal \returns the sum of the elements of \a a by block of 4 elements.
  * For a packet {a0, a1, a2, a3, a4, a5, a6, a7}, it returns a half packet
 ...
 */
template <typename Packet>
EIGEN_DEVICE_FUNC inline Packet pinsertfirst(
    const Packet& a, typename unpacket_traits<Packet>::type b) {
 ...
 */
template <typename Packet>
EIGEN_DEVICE_FUNC inline Packet pinsertlast(
    const Packet& a, typename unpacket_traits<Packet>::type b) {
  // Default implementation based on pblend.
  // It must be specialized for higher performance.
  Selector<unpacket_traits<Packet>::size> mask;
