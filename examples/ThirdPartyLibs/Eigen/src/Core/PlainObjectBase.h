...
// Moreover, doxygen fails to include members that are not documented in the
// declaration body of
// MatrixBase if we inherits MatrixBase<Matrix<_Scalar, _Rows, _Cols, _Options,
// _MaxRows, _MaxCols> >,
...
#include EIGEN_PLAINOBJECTBASE_PLUGIN
 ...
 protected:
  ...
  // Matrix, or a dynamic-sized Array,
  ...
  // the unique coefficient (case where scalar type can be implicitely
  // converted)
  template <typename T>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void _init1(
