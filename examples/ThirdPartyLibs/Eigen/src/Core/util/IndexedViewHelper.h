 ...
 * symbolically reference the last element/row/columns
  * of the underlying vector or matrix once passed to
...
/** \var end
  ...
  *
  * Can be used as a parameter to Eigen::seq and Eigen::seqN functions to
 * symbolically reference the last+1 element/row/columns
  * of the underlying vector or matrix once passed to
 * DenseBase::operator()(const RowIndices&, const ColIndices&).
  *
  * This symbolic placeholder support standard arithmetic operation.
...
// of type T into something usable by MatrixSlice
...
// exposes a .size(), and operatro[](int) methods)
