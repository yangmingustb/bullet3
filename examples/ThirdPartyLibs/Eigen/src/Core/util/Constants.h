 ...
 * either very expensive or
  * cannot be known at compile time.
  *
  * This value has to be positive to (1) simplify cost computation, and (2)
 * allow to distinguish between a very expensive and very very expensive
 * expressions.
 ...
 * to the first element regardless
