...
#endif  // not EIGEN_PARSED_BY_DOXYGEN
{
 public:
   ...
   * such as
    *          PermutationMatrix or Transpositions, otherwise it defaults to
   * Eigen::Index
  ...
  typedef CwiseNullaryOp<internal::linspaced_op<Scalar, PacketScalar>,
                         PlainObject>
  ...
  EIGEN_DEVICE_FUNC static const SequentialLinSpacedReturnType LinSpaced(
   ...
   * this function just returns
    ...
    *
    * \warning Be carefull with eval() and the auto C++ keyword, as detailed in
