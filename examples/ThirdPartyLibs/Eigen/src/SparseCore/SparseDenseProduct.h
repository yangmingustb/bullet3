...
struct sparse_time_dense_product_impl<SparseLhsType, DenseRhsType, DenseResType,
  ...
  static void run(const SparseLhsType& lhs, const DenseRhsType& rhs,
    ...
    for (Index c = 0; c < rhs.cols(); ++c) {
      ...
      // problems.
      // It basically represents the minimal amount of work to be done to be
      // worth it.
...
struct generic_product_impl<Lhs, Rhs, SparseShape, DenseShape, ProductType>
    : generic_product_impl_base<
          Lhs, Rhs, generic_product_impl<Lhs, Rhs, SparseShape, DenseShape,
                                         ProductType> > {
...
struct generic_product_impl<Lhs, Rhs, DenseShape, SparseShape, ProductType>
    : generic_product_impl_base<
          Lhs, Rhs, generic_product_impl<Lhs, Rhs, DenseShape, SparseShape,
                                         ProductType> > {
  typedef typename Product<Lhs, Rhs>::Scalar Scalar;
