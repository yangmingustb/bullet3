...
class IterativeSolverBase : public SparseSolverBase<Derived> {
 ...
 public:
   ...
   * preconditioner. In the future
    * we might, for instance, implement column reordering for faster matrix
   * vector products.
    */
  template <typename MatrixDerived>
   ...
   * \c Ax=b problems.
    *
    * Currently, this function mostly initializes/computes the preconditioner.
   * In the future
    * we might, for instance, implement column reordering for faster matrix
   * vector products.
    *
  ...
  void _solve_impl(const Rhs& b, SparseMatrixBase<DestDerived>& aDest) const {
    ...
    // of aliasing issue.
    // For non square least-square problems, b and dest might not have the same
    // size whereas they might alias each-other.
