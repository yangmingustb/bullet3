...
typename internal::enable_if<
    valid_indexed_view_overload<RowIndices, ColIndices>::value &&
 ...
 * positive sizes \c (rows,columns), then this
  * method will returns a Block object after extraction of the relevant
 * information from the passed arguments. This is the case
 ...
 * will be returned, after conversion of the inputs
