...
vector<PortInfo> serial::list_ports() {
  ...
  while (SetupDiEnumDeviceInfo(device_info_set, device_info_set_index,
    ...
    LONG return_code = RegQueryValueEx(hkey, _T("PortName"), NULL, NULL,
    ...
    BOOL got_friendly_name = SetupDiGetDeviceRegistryProperty(
        device_info_set, &device_info_data, SPDRP_FRIENDLYNAME, NULL,
    ...
    BOOL got_hardware_id = SetupDiGetDeviceRegistryProperty(
        device_info_set, &device_info_data, SPDRP_HARDWAREID, NULL,
        (PBYTE)hardware_id, hardware_id_max_length, &hardware_id_actual_length);
